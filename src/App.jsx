  ...
  return (
    <>
      <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-10 grid-cols-1">
        ...
        <div className="animate__animated animate__fadeInUp animate__delay-3s">
          <div className="flex items-center gap-3 mb-6 bg-zinc-800 w-fit p-4 rounded-2xl">
            ...
            <q>You’re on Your Own, Kid</q>
          </div>

          <h1 className="text-5xl/tight font-bold mb-6">Hi! I'm Achmad Doli Harahap</h1>

          <p className="text-base/loose mb-6 opacity-50">
            An Informatics Engineering student with a strong background in applied system development, particularly in IoT-based monitoring solutions, data-driven applications, and system integration. My academic experience includes
            publishing an IoT-related study in a peer-reviewed journal and participating in an international exchange program at National Formosa University, Taiwan, through the IISMA initiative. I am driven to contribute to
            technology-focused internship programs where engineering solutions are developed, evaluated, and deployed to address practical challenges.
          </p>

          <div className="flex items-center sm:gap-4 gap-2">
            <a href="https://drive.google.com/file/d/1z3dbsVM9xiWcqi6wW5mu2-MLl1KdKQ19/view?usp=sharing" className="bg-violet-700 p-4 rounded-2xl hover:bg-violet-600">
        ...
        {/* RIGHT SIDE */}
        <div className="relative md:ml-auto animate__animated animate__fadeInUp animate__delay-4s">
          <div className="absolute inset-0 bg-violet-600 blur-3xl opacity-20 rounded-full"></div>

          <img src={DataImage.HeroImage} alt="Hero Image" className="relative w-[380px] h-[450px] object-cover rounded-3xl border border-zinc-700 shadow-2xl" loading="lazy" />
        </div>
      </div>
      ...
      <div className="about mt-32 py-10" id="about">
        <div className="xl:w-2/3 lg:w-3/4 w-full mx-auto p-7 bg-zinc-800 rounded-lg" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
          ...
          <p className="text-base/loose mb-10">
            Driven by an interest in solving real-world problems, I enjoy building practical systems that transform fragmented processes into structured and meaningful solutions. Eager to explore interdisciplinary learning experiences and
            create technologies that improve efficiency and simplify real-world workflows.
          </p>
      ...
      <div className="kontak mt-32 sm:p-10 p-0" id="kontak">
        ...
        <form
          action="https://formsubmit.co/achmaddoliharahap@gmail.com"
          method="POST"
        ...
        >
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-2">
              <label classNamee="font-semibold">Full Name</label>
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="pesan" classNamee="font-semibold">
                Message
              </label>
              <textarea name="pesan" id="pesan" cols="45" rows="7" placeholder="Write your message..." className="border border-zinc-500 p-2 rounded-md" required></textarea>
            </div>
