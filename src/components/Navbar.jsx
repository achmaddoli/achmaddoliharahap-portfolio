...
const Navbar = () => {
  ...
  return (
    <div className="navbar py-7 flex items-center justify-between">
      ...
      <ul
        className={`menu flex items-center sm:gap-10 gap-4 md:static fixed left-1/2 -translate-x-1/2 md:translate-x-0 md:opacity-100 md:top-0 bg-white/30 backdrop-blur-md p-4 rounded-br-2xl md:bg-transparent transition-all md:transtion-none z-40 ${active ? 'top-0 opacity-100' : '-top-10 opacity-0'}`}
      >
        <li>
